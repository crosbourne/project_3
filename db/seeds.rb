...
Comic.create!([
  ...
  {name: "Thanos", description: "Thanos is contemplating what is to be done now that he has the power of god. ", comic_image: nil, user_id: 1, album_id: 5, issue_number: 1, comic_heading: "Infinity Guantlet", bubble_name: "Thanos", bubble_number: 43, remote_comic_image_url: "http://imageserver.moviepilot.com/marvel-s-avengers-3-civil-war-or-infinity-gauntlet-dfb85103-9fc5-4d64-9e79-5ef2241c69ad.png?width=630&height=969"},

  {name: "The Incredible Hulk", description: "The Hulk is a superhero that appears in comic books published by Marvel Comics. The character was created by Stan Lee and Jack Kirby, and first appeared in The Incredible Hulk #1 (May 1962). ", comic_image: nil, user_id: 1, album_id: 4, issue_number: 1, comic_heading: "First Appearance", bubble_name: "Hulk", bubble_number: 200, remote_comic_image_url: "http://4.bp.blogspot.com/-JkxGglIBl_A/Tk_Hr0enbvI/AAAAAAAAFV8/W70eiWG_e18/s1600/01.png"},
