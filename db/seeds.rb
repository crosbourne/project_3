...
Comic.create!([
  ...
  {name: "Watchmen", description: "Featuring the first appearance of Rorschach, Ozymandias, Dr. Manhattan, Silk Spectre, Nite Owl, and the Comedian! ", comic_image: nil, user_id: 1, album_id: 1, issue_number: 1, comic_heading: "Game changing comic", bubble_name: "Watchmen", bubble_number: 42, remote_comic_image_url: "http://static.comicvine.com/uploads/scale_large/8/80654/2184494-watchmen__1_pg_00.jpg"},
])
